defmodule GroupingStageTest do
  ...
  describe "ideas in the grouping stage" do
    ...
    test "can be drag-and-dropped on one client and have their position update across all clients", %{retro: retro, session: session, non_facilitator: non_facilitator} do
